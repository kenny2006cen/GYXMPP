...
@property (nonatomic, weak) GYPhotoPickerServiceBlock block;
    ...
    if (self = [super init]) {
        ...
        if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
            [UIActionSheet showInView:controller.view
                             withTitle:nil
                    cancelButtonTitle:[GYKitCommon localizedStringForKey:@"GYKitOhterCancel"]
                destructiveButtonTitle:nil
                     otherButtonTitles:@[ [GYKitCommon localizedStringForKey:@"GYKitOhterPhoto"], [GYKitCommon localizedStringForKey:@"GYKitOhterCamel"],[GYKitCommon localizedStringForKey:@"GYKitOhterAlbum"] ]
            ...
            [UIActionSheet showInView:controller.view
                     ...
                     cancelButtonTitle:[GYKitCommon localizedStringForKey:@"GYKitOhterCancel"]
                destructiveButtonTitle:nil
                     otherButtonTitles:@[[GYKitCommon localizedStringForKey:@"GYKitOhterPhoto"], [GYKitCommon localizedStringForKey:@"GYKitOhterAlbum"]]
                              tapBlock:^(UIActionSheet* _Nonnull actionSheet, NSInteger buttonIndex) {
