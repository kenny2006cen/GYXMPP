...
public extension UIBarButtonItem {
    ...
    ///设置图片item 里面已处理保持原图
    static func hm_item(_ image: UIImage, _ style: UIBarButtonItem.Style = .plain, _ target: Any?, _ action: Selector?) -> UIBarButtonItem  {
    ...
    ///设置item 标题
    static func hm_item(_ title: String, _ style: UIBarButtonItem.Style = .plain, _ target: Any?, _ action: Selector?) -> UIBarButtonItem  {
