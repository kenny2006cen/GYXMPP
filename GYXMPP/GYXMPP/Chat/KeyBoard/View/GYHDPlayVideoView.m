...
- (void)layoutSubviews {
  ...
  [self.recordViewTool playRecordVideoWithView:self.playerVideoView
                                          Data:self.Data];
...
- (void)setup {
  ...
  [playVideoButton setBackgroundImage:[UIImage imageNamed:@"btn_lx_bf_n"]
                             forState:UIControlStateNormal];
  [playVideoButton setBackgroundImage:[UIImage imageNamed:@"btn_lx_bf_h"]
                             forState:UIControlStateHighlighted];
  ...
  [pauseVideoButton setBackgroundImage:[UIImage imageNamed:@"btn_lx_zt_n"]
                              forState:UIControlStateNormal];
  [pauseVideoButton setBackgroundImage:[UIImage imageNamed:@"btn_lx_zt_h"]
                              forState:UIControlStateHighlighted];
  [pauseVideoButton addTarget:self
                       action:@selector(buttonClick:)
             forControlEvents:UIControlEventTouchUpInside];
  ...
  [sendVideoButton setBackgroundImage:[UIImage imageNamed:@"btn_lx_fs_n"]
                             forState:UIControlStateNormal];
  [sendVideoButton setBackgroundImage:[UIImage imageNamed:@"btn_lx_fs_h"]
                             forState:UIControlStateHighlighted];
  [sendVideoButton addTarget:self
                      action:@selector(buttonClick:)
            forControlEvents:UIControlEventTouchUpInside];
...
- (void)buttonClick:(UIButton *)button {
  if ([button isEqual:self.playVideoButton]) {
    ...
    if ([self.delegate
            respondsToSelector:@selector(GYHDPlayVideoView:DidSendData:)]) {
