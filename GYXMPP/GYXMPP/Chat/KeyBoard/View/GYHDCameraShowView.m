...
- (void)setup {
  ...
  [cancelButton setBackgroundImage:[UIImage imageNamed:@"camera_sc_n"]
                          forState:UIControlStateNormal];
  [cancelButton setBackgroundImage:[UIImage imageNamed:@"camera_sc_h"]
  ...
  [sendButton setBackgroundImage:[UIImage imageNamed:@"brn-ps_qd_n"]
                        forState:UIControlStateNormal];
  [sendButton setBackgroundImage:[UIImage imageNamed:@"brn-ps_qd_h"]
                        forState:UIControlStateHighlighted];
...
- (void)sendButtonClick {
  [self disMiss];
  if ([self.delegate
          respondsToSelector:@selector(GYHDCameraShowView:SendImageData:)]) {
