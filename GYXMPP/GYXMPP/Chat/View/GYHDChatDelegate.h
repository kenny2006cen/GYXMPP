...
/**点击*/
- (void)GYHDChatView:(UIView *)view
             tapType:(GYHDChatTapType)type
           chatModel:(GYHDNewChatModel *)chatModel;
/**长按*/
- (void)GYHDChatView:(UIView *)view
         longTapType:(GYHDChatTapType)type
        selectOption:(GYHDChatSelectOption)option
       chatMessageID:(NSString *)chatMessageID;
@end
