...
typedef NS_ENUM(NSInteger,HMAPDeviceState) {
    HMAPDeviceStateUnkown = -1,//默认
    HMAPDeviceStateInAP = 0,//处于配网状态
    HMAPDeviceStateInSetting = 1,//处于设置用户状态
};
...
@property (nonatomic, assign) HMAPDeviceState deviceState;
@end
