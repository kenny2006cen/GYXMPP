...
@interface GYHDChatImageShowView ()<UIActionSheetDelegate,
...
//  [self.showImageView
//      setImageWithURL:url placeholder:[UIImage imageNamed:@"placeholder_image"] options:kNilOptions completion:nil ];
}
- (void)disMiss {
...
- (void)scrollViewDidEndZooming:(UIScrollView *)scrollView
                       withView:(UIView *)view
                        atScale:(float)scale {
 // DDLogInfo(@"scrollViewDidEndZooming : %f", scale);
