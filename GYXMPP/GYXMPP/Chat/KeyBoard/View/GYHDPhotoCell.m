...
- (void)setup {
  ...
  [photoSelectButton setImage:[UIImage imageNamed:@"photo_normal"]
                     forState:UIControlStateNormal];
  [photoSelectButton setImage:[UIImage imageNamed:@"photo_select"]
                     forState:UIControlStateSelected];
  [photoSelectButton addTarget:self
                        action:@selector(photoButtonClick:)
